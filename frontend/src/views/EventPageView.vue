...
onMounted(()=>{
    document.title = 'Events - Chitrakala'
...
<template>
    <div class="min-h-[100vh] event-list-container bg-[rgb(0,0,0)] flex flex-col gap-8 justify-center py-4 ssm:pb-12 px-8">
        ...
        <span class="text-center font-montserrat text-[#6cb9b2] font-extrabold tracking-wide text-[40px] sm:text-[46px] relative mt-[74px]">Chitrakala Events</span>
